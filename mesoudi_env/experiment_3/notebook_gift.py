...
def run_simulation_loop(
    ...
    def _apply_group_prestige_gain_change_to_q_vals(
        ...
        # nudge their innovation preference toward that new incentive.
    ...
    def body_fn(carry, t):
        ...
        # Separate immediate payoff learning from gift-income credit assignment.
        # Paying a gift is learned as a cost of the chosen imitation action, but
        # receiving gifts is credited directly to innovation.
    ...
    metrics[11] = jnp.cumsum(metrics[11])  # cumulative gift transfers
